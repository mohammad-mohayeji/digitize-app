...
export default function Home() {
  ...
  useEffect(() => {
    const res1 = axios.get("http://https://vercel-restful-api.vercel.app/mobile/1");
    const res3 = axios.get("http://https://vercel-restful-api.vercel.app/lapTop/1");
    const res2 = axios.get("http://https://vercel-restful-api.vercel.app/mobile/2");
    const res4 = axios.get("http://https://vercel-restful-api.vercel.app/smartWatch/1");
    const res5 = axios.get("http://https://vercel-restful-api.vercel.app/lapTop/3");
    const res6 = axios.get("http://https://vercel-restful-api.vercel.app/smartWatch/3");
