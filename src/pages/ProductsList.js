...
export default function ProductsList() {
  ...
  return (
    <div>
      <MobileTopNav title={title} />
      <MobileFilterModal searchBoxHandler={searchBoxHandler} />
      <div className="container mx-auto xl:max-w-screen-xl grid grid-cols-12 md:grid-rows-[60px_minmax(500px,_1fr)] md:gap-8 md:px-4 md:mt-6 mb-10 pb-10">
        <SideBar />
        ...
        {loading && (
          <div className="col-span-12 md:col-span-8 lg:col-span-9">
            <ImSpinner2
              size={38}
              className="text-orange-500 animate-spin mx-auto mt-28"
            />
          </div>
        )}
        {!loading && (
          <div className="col-span-12 md:col-span-8 lg:col-span-9">
            {products.length ? (
              ...
              <div className="text-center text-3xl text-gray-400 mt-16 mb-20 lg:mt-48">
                محصولی یافت نشد !
              </div>
            )}
          </div>
