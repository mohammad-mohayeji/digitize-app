...
export default function MobileFilterModal() {
  const { setPriceRange } = useContext(GlobalContext);
  ...
  return (
    ...
    <div>
      <div className="flex lg:hidden justify-between items-center gap-x-3 mb-9 px-5">
        <button className="w-full bg-white rounded-md p-2 flex items-center">
          ...
          <span className="mr-2 text-sm sm:text-base font-semibold text-slate-800">محبوبترین محصول</span>
        </button>
        <button onClick={(e)=> setShowModal(true)} className="w-full bg-white rounded-md p-2 flex items-center">
          ...
          <span className="mr-2 text-sm sm:text-base font-semibold text-slate-800">فیلتر</span>
        </button>
      </div>
            ...
            <div className="text-slate-800 mb-2">
              ...
              <div className={`${accDisplay} p-4 flex flex-col gap-y-2`}>
                <div className="flex items-center gap-x-3">
                  <input onChange={(e) => setPriceRange(e.target.value)} defaultChecked value="any" name="price" id="priceRange1" type="radio" className="form-checkbox rounded text-orange-500 focus:ring-orange-500"/>
                  <label htmlFor="priceRange1" className="font-semibold">همه</label>
                </div>
                <div className="flex items-center gap-x-3">
                  <input onChange={(e) => setPriceRange(e.target.value)} value="10000000 - 20000000" name="price" id="priceRange2" type="radio" className="form-checkbox rounded text-orange-500 focus:ring-orange-500"/>
                  <label htmlFor="priceRange2" className="font-semibold">۱۰,۰۰۰,۰۰۰ - ۲۰,۰۰۰,۰۰۰</label>
                </div>
                <div className="flex items-center gap-x-3">
                  <input onChange={(e) => setPriceRange(e.target.value)} value="20000000 - 30000000" name="price" id="priceRange3" type="radio" className="form-checkbox rounded text-orange-500 focus:ring-orange-500"/>
                  <label htmlFor="priceRange3" className="font-semibold">۲۰,۰۰۰,۰۰۰ - ۳۰,۰۰۰,۰۰۰
                  </label>
                </div>
                <div className="flex items-center gap-x-3">
                  <input onChange={(e) => setPriceRange(e.target.value)} value="30000000 - 40000000" name="price" id="priceRange4" type="radio" className="form-checkbox rounded text-orange-500 focus:ring-orange-500"/>
                  <label htmlFor="priceRange4" className="font-semibold">۳۰,۰۰۰,۰۰۰ - ۴۰,۰۰۰,۰۰۰
                  </label>
                </div>
                <div className="flex items-center gap-x-3">
                  <input onChange={(e) => setPriceRange(e.target.value)} value="40000000 - 50000000" name="price" id="priceRange5" type="radio" className="form-checkbox rounded text-orange-500 focus:ring-orange-500"/>
                  <label htmlFor="priceRange5" className="font-semibold">۴۰,۰۰۰,۰۰۰ - ۵۰,۰۰۰,۰۰۰</label>
                </div>
                <div className="flex items-center gap-x-3">
                  <input onChange={(e) => setPriceRange(e.target.value)} value="50000000 - 60000000" name="price" id="priceRange6" type="radio" className="form-checkbox rounded text-orange-500 focus:ring-orange-500"/>
                  <label htmlFor="priceRange6" className="font-semibold">۵۰,۰۰۰,۰۰۰ - ۶۰,۰۰۰,۰۰۰</label>
                </div>
                <div className="flex items-center gap-x-3">
                  <input onChange={(e) => setPriceRange(e.target.value)} value="60000000 - 70000000" name="price" id="priceRange7" type="radio" className="form-checkbox rounded text-orange-500 focus:ring-orange-500"/>
