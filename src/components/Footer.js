      ...
      <div className="container mx-auto xl:max-w-screen-xl flex flex-wrap md:gap-9 lg:gap-0 items-center justify-between text-slate-800">
        <div>
          ...
          <p className="max-w-[500px] text-xl">
            ...
            <span className="text-orange-400 font-semibold"> ۱۲۲,۲۳۲ نفر </span>
            تا به اکنون خدمت رسانی داشته باشد.
          </p>
        </div>
        <div>
          <h4 className="font-bold text-xl mb-4">محصولات</h4>
          <ul className="flex flex-col gap-y-4 font-medium">
            <li>
              <Link to="productslist/mobile" className="hover:text-orange-500">تلفن همراه</Link>
            </li>
            <li>
              <Link to="productslist/lapTop" className="hover:text-orange-500">لپ تاپ</Link>
            </li>
            <li>
              <Link to="productslist/smartWatch" className="hover:text-orange-500">ساعت هوشمند</Link>
            </li>
          </ul>
        </div>
        <div>
          ...
          <div className="flex flex-col gap-y-2 items-end font-medium">
            <div className="flex items-center gap-x-2">
              ...
              <PhoneIcon width="18px" className="fill-orange-400" />
            </div>
            <div className="flex items-center gap-x-2">
              <span>info@digitize.com</span>
              <EnvelopeIcon width="18px" className="fill-orange-400" />
            </div>
          </div>
        </div>
      </div>
